...
{ 
    public class oAuthFacebook
    {
        ...
        public const string CALLBACK_URL = "http://localhost:1738/home/index";
        //permisos extendidos
        ...
        public string ConsumerKey
        {
            get
            {
                ...
                {
                    _consumerKey = "361970303856289"; //Your application ID
                }
                return _consumerKey;
            }
        ...
        public string ConsumerSecret
        {
            get
            {
                ...
                {
                    _consumerSecret = "940babd6993bfe16f8b3d677c6e46b17"; //Your application secret
                }
        ...
        public string Token { get { return System.Web.HttpContext.Current.Session["Token"].ToString(); } set { _token = value; } }
        #endregion
        ...
        {
            return string.Format("{0}?client_id={1}&redirect_uri={2}&scope={3}", AUTHORIZE, this.ConsumerKey, CALLBACK_URL, SCOPE);
        }
        ...
        public void AccessTokenGet(string authToken)
        {
            ...
            if (response.Length > 0)
            {
                ...
                if (qs["access_token"] != null)
                {
                    ...
                    //Utilizo una variable de sesión para el token
                    System.Web.HttpContext.Current.Session["Token"] = qs["access_token"];
                }
            }
        }
